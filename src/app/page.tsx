    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-40 w-full bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          <Link href="/" className="flex items-center space-x-2 font-bold text-2xl text-gray-900 hover:text-blue-600 transition-colors">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Link href="#features" className="text-gray-600 hover:text-blue-600 transition-colors text-lg">Features</Link>
            <Link href="#testimonials" className="text-gray-600 hover:text-blue-600 transition-colors text-lg">Testimonials</Link>
            <Link href="#pricing" className="text-gray-600 hover:text-blue-600 transition-colors text-lg">Pricing</Link>
            <Link href="#contact" className="text-gray-600 hover:text-blue-600 transition-colors text-lg">Contact</Link>
            <Link href="/login" className="text-gray-600 hover:text-blue-600 transition-colors text-lg">Sign In</Link>
            <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-4 py-4 space-y-4">
              ...
              <Link href="#testimonials" className="block text-gray-600 hover:text-blue-600 transition-colors">Testimonials</Link>
              ...
              <Link href="/login" className="block text-gray-600 hover:text-blue-600 transition-colors">Sign In</Link>
      ...
      {/* Hero Section */}
      <section className="relative py-20 md:py-32 text-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <div className="container mx-auto px-4 relative z-10">
          <Badge variant="secondary" className="bg-blue-100 text-blue-800 px-4 py-1 rounded-full text-md mb-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg transform hover:scale-105 transition-all duration-300">
              <Link href="/register">Start Free Trial <ArrowRight className="ml-2 h-5 w-5" /></Link>
            </Button>
            <Button 
              variant="outline" 
              className="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-full text-lg font-semibold shadow-lg transform hover:scale-105 transition-all duration-300 hover:bg-blue-50"
      ...
      {isVideoOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75 p-4">
          <div className="relative w-full max-w-4xl aspect-video bg-white rounded-lg shadow-2xl">
            <button
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card 
                key={index} 
                className={`${feature.color} text-gray-900 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 group`}
              >
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row items-center w-full mb-16">
              ...
              <div className="md:w-1/2 flex justify-start md:justify-end">
                <div className="p-5 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 shadow-xl flex items-center justify-center text-white text-2xl font-bold border-4 border-white">
                  <Rocket className="h-8 w-8" />
                </div>
              </div>
            </div>

            <div className="flex flex-col md:flex-row-reverse items-center w-full mb-16">
              ...
              <div className="md:w-1/2 flex justify-end md:justify-start">
                <div className="p-5 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 shadow-xl flex items-center justify-center text-white text-2xl font-bold border-4 border-white">
            ...
            <div className="flex flex-col md:flex-row items-center w-full">
              ...
              <div className="md:w-1/2 flex justify-start md:justify-end">
                <div className="p-5 rounded-full bg-gradient-to-br from-green-500 to-teal-500 shadow-xl flex items-center justify-center text-white text-2xl font-bold border-4 border-white">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card 
                key={index} 
                className="bg-white border border-gray-200 text-gray-900 rounded-xl shadow-lg p-6 hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300"
              >
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <Card 
                key={index} 
                className={`relative bg-white border text-gray-900 rounded-xl shadow-lg p-8 flex flex-col transform hover:scale-105 transition-all duration-300 ${plan.isPopular ? 'border-blue-500 shadow-blue-500/30' : 'border-gray-200'}`}
              >
                {plan.isPopular && (
                ...
                <CardHeader className="text-center pb-6">
                  ...
                  <p className="mt-4 text-5xl font-extrabold text-gray-900">
                    {plan.price}
                    {plan.frequency && <span className="text-xl font-medium text-gray-600">{plan.frequency}</span>}
                  </p>
                </CardHeader>
      ...
      {/* Call to Action */}
      <section className="py-20 md:py-28 bg-blue-600 text-center">
        <div className="container mx-auto px-4">
          ...
          <Button asChild className="bg-white text-blue-600 hover:bg-gray-100 px-10 py-4 rounded-full text-xl font-semibold shadow-lg transform hover:scale-105 transition-all duration-300">
      ...
      {/* Footer */}
      <footer id="contact" className="bg-gray-900 py-12 text-gray-300">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2 font-bold text-2xl text-white hover:text-blue-400 transition-colors">
              <Shield className="h-7 w-7 text-blue-500" />
              <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Kavach.ai</span>
            </Link>
            <p className="text-gray-400">Your trusted partner for legal compliance in India.</p>
